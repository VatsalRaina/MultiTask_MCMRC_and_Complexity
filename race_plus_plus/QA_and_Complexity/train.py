...
def main(args):
    ...
    labels_complexity = [0]*num_middle + [1]*num_high + [2]*num_college
    ...
    train_data = TensorDataset(input_ids, token_type_ids, attention_masks, labels, labels_complexity)
    ...
    criterion_complexity = torch.nn.CrossEntropyLoss()
    ...
    file_path = args.save_path+'electra_QA_complexity_MC_seed'+str(args.seed)+'.pt'
